       ...
       <form  onSubmit={handleOnSubmit} className="flex  flex-col justify-center items-center gap-y-4">
                    ...
                    <label>
                        ...
                        <input 
                            ...
                            className="w-[200px] rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-500"
                        />
                    </label>
                    ...
                    <label>
                        ...
                        <input 
                            ...
                            className="w-[200px]  rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5"
                        />
                    </label>
                    ...
                    <label className="relative">
                        ...
                        <input 
                            ...
                            className = "w-[200px]  rounded-[0.5rem] bg-richblack-800 p-[12px] pr-10 text-richblack-5"
                        />
                        <span 
                    ...
                    <button 
                        type="submit"
                        className="mt-6 w-[200px]  rounded-[8px] bg-yellow-50 py-[8px] px-[12px] font-medium text-richblack-900"
                    >
                        Create Account
                    </button>
